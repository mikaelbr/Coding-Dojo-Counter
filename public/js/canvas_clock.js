...
var canvasPieTimer = {
    ...
    init: function(canvasSize, canvasId, parentId){
        ...
        this.createCanvas(canvasId, this.canvasSize);
    ...
    drawText: function () {
        ...
        // draw the outer circle
        var draw = this.canvas.getContext("2d"),
            time = parseFloat((this.timeLimit - this.timeElapsed) / 1000).toFixed(1);

        draw.globalAlpha = 1;
        draw.textAlign = "center";
        draw.font = "20pt Arial";
        draw.fillStyle = this.fontColour;

        draw.fillText( time + " seconds", drawX, drawY);
        // draw.fill();
    },
